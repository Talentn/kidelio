...
import { Baby, Crown, Footprints, Shirt, Sparkles } from 'lucide-react'

const AGE_LINKS = [
  { label: 'Femme', sub: 'Prêt-à-porter', to: '/produits', icon: Crown },
  { label: 'Robes', sub: 'Tendance', to: '/produits?q=robe', icon: Shirt },
  { label: 'Ensembles', sub: 'Nouveautés', to: '/produits?q=ensemble', icon: Sparkles },
  { label: 'Enfant', sub: '3 – 12 ans', to: '/produits?age=6-12', icon: Baby },
